...
static NSTimeInterval _YD_CGImageSourceGetGIFFrameDelayAtIndex(CGImageSourceRef source, size_t index) {
...
@implementation UIImage (YDCommon)
...
+ (UIImage *)imageWithSmallGIFData:(NSData *)data scale:(CGFloat)scale {
    ...
    for (size_t i = 0; i < count; i++) {
        NSTimeInterval delay = _YD_CGImageSourceGetGIFFrameDelayAtIndex(source, i);
        totalTime += delay;
