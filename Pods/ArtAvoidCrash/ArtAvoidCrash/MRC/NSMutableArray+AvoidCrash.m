...
+ (void)avoidCrashExchangeMethod {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [AvoidCrash exchangeInstanceMethod:arrayMClass method1Sel:@selector(objectAtIndexedSubscript:) method2Sel:@selector(avoidObjectAtIndexedSubscript:)];
        
        //addObject:
        [AvoidCrash exchangeInstanceMethod:arrayMClass method1Sel:@selector(addObject:) method2Sel:@selector(avoidAddObject:)];
        
        //replaceObjectAtIndex:withObject:
        [AvoidCrash exchangeInstanceMethod:arrayMClass method1Sel:@selector(replaceObjectAtIndex:withObject:) method2Sel:@selector(avoidReplaceObjectAtIndex:withObject:)];
        
        //removeObjectsInRange:
        [AvoidCrash exchangeInstanceMethod:arrayMClass method1Sel:@selector(removeObjectsInRange:) method2Sel:@selector(avoidRemoveObjectsInRange:)];
        
        //subarrayWithRange:
        [AvoidCrash exchangeInstanceMethod:arrayMClass method1Sel:@selector(subarrayWithRange:) method2Sel:@selector(avoidSubarrayWithRange:)];
