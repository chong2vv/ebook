...
+ (void)avoidCrashExchangeMethod {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [AvoidCrash exchangeClassMethod:[self class] method1Sel:@selector(arrayWithObject:) method2Sel:@selector(AvoidCrashArrayWithObject:)];
        ...
        //subarrayWithRange
        [AvoidCrash exchangeInstanceMethod:__NSArray0 method1Sel:@selector(subarrayWithRange:) method2Sel:@selector(__NSArray0AvoidCrashSubarrayWithRange:)];
        
        [AvoidCrash exchangeInstanceMethod:__NSArrayI method1Sel:@selector(subarrayWithRange:) method2Sel:@selector(__NSArrayIAvoidCrashSubarrayWithRange:)];
        
        [AvoidCrash exchangeInstanceMethod:__NSSingleObjectArrayI method1Sel:@selector(subarrayWithRange:) method2Sel:@selector(__NSSingleObjectArrayIAvoidCrashSubarrayWithRange:)];
        ...
        [AvoidCrash exchangeInstanceMethod:__NSArray0 method1Sel:@selector(objectAtIndexedSubscript:) method2Sel:@selector(__NSArray0AvoidCrashObjectAtIndexedSubscript:)];
        ...
        [AvoidCrash exchangeInstanceMethod:__NSSingleObjectArrayI method1Sel:@selector(objectAtIndexedSubscript:) method2Sel:@selector(__NSSingleObjectArrayIAvoidCrashObjectAtIndexedSubscript:)];
    });
