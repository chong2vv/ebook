...
+ (void)avoidCrashExchangeMethod {
    ...
    dispatch_once(&onceToken, ^{
        ...
        [AvoidCrash exchangeClassMethod:[self class] method1Sel:@selector(stringWithUTF8String:) method2Sel:@selector(hookStringWithUTF8String:)];
        
        [AvoidCrash exchangeClassMethod:[self class] method1Sel:@selector(stringWithCString:encoding:) method2Sel:@selector(hookStringWithCString:encoding:)];
        
        
        //====================
        //   instance method
        //====================
        [AvoidCrash exchangeInstanceMethod:stringClass method1Sel:@selector(stringByAppendingString:) method2Sel:@selector(hookStringByAppendingString:)];
        
        [AvoidCrash exchangeInstanceMethod:stringClass method1Sel:@selector(rangeOfString:options:range:locale:) method2Sel:@selector(hookRangeOfString:options:range:locale:)];
    });
